...
class RuntimePropertyPackageDataMixin:
    def _evaluate_property_package_data_node(self, node, node_type):
        ...
        if node_type == "AFNodeMergePropertyAssignments":
            base_assignment = self._get_linked_output(node, "Base Prop Assign", "property_assignment")
            add_assignment = self._get_linked_output(node, "Add Prop Assign", "property_assignment")
        ...
        if node_type == "AFNodeMergePropertyPackages":
            base_package = self._get_linked_output(node, "Base Prop Pack", "property_package")
            add_package = self._get_linked_output(node, "Add Prop Pack", "property_package")
