...
class RuntimeTaskRefCommonMixin:
    ...
    def _auto_flow_bake_action_name_from_task_ref(self, task_ref):
        return _auto_flow_bake_action_name_from_task_ref(task_ref)
    ...
    def _rehydrate_auto_flow_bake_predicted_items(self, task_ref, scene):
        return _rehydrate_auto_flow_bake_predicted_items_impl(
            task_ref,
            scene,
            predict_auto_flow_bake_targets_resilient=self._predict_auto_flow_bake_targets_resilient,
        )
