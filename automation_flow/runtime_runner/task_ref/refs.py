...
from .auto_flow import RuntimeTaskRefAutoFlowMixin
...
class RuntimeTaskRefsMixin(
    ...
    def _build_physics_task_ref(self, node):
        object_ref, modifier = self._resolve_physics_task_target(node.physics_task_path, node.name)
