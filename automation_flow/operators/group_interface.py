...
GROUP_INTERFACE_SOCKET_TYPE_ITEMS = (
    ...
    ("AFSocketPropertyPackage", "Prop Pack", "NODE_COMPOSITING"),
    ("AFSocketPropertyDefinition", "Prop Def", "PREFERENCES"),
    ("AFSocketPropertyAssignment", "Prop Assign", "SETTINGS"),
...
class AF_OT_AddGroupInterfaceSocket(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        try:
            from ..tree import _queue_group_tree_sync
