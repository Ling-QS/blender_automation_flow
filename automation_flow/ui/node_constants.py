...
PROPERTY_PACKAGE_STORE_MODE_ITEMS = (
    ("STORE_AND_OUTPUT", "Store", "Store the incoming Prop Pack on this node and output it"),
    ("OUTPUT_ONLY", "Output", "Ignore the incoming Prop Pack and output the previously stored one"),
)

APPLY_OBJECT_PROPERTIES_MODE_ITEMS = (
    ("PACKAGE", "Prop Pack", "Apply properties from a Prop Pack"),
    ("ASSIGNMENT", "Prop Assign", "Apply properties directly from Prop Assign inputs"),
)
...
PROPERTY_DATA_OUTPUT_MODE_ITEMS = (
    ("ASSIGNMENT", "Prop Assign", "Output Prop Assign data"),
...
PREVIEW_DATA_MODE_SPECS = {
    ...
    "PROPERTY_DEFINITION": ("AFSocketPropertyDefinition", "Prop Def", "property_definition"),
    "PROPERTY_ASSIGNMENT": ("AFSocketPropertyAssignment", "Prop Assign", "property_assignment"),
    "PROPERTY_PACKAGE": ("AFSocketPropertyPackage", "Prop Pack", "property_package"),
