...
_UI_EXPORT_MODULES = (overlays, menus, panels, preferences, assembly)
...
CLASSES = assembly.build_ui_classes(
...
def __getattr__(name):
    return resolve_module_export(_UI_EXPORT_MODULES, name, __name__)
