...
class AFAddonPreferences(bpy.types.AddonPreferences):
    ...
    show_bake_status_chips: bpy.props.BoolProperty(
        ...
        description="Draw cache state chips for GN Bake, Physics Bake, and Auto Flow Bake nodes",
        default=True,
    )
    show_stored_package_chips: bpy.props.BoolProperty(
        name="Stored Prop Pack Chips",
        description="Draw stored prop pack chips for Store Prop Pack nodes",
        default=True,
    )
    show_group_output_package_chips: bpy.props.BoolProperty(
        name="Group Output Prop Pack Chips",
